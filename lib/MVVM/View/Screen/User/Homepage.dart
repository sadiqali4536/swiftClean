...
//   List<QueryDocumentSnapshot> get filteredServices {
//     List<QueryDocumentSnapshot> filtered = _allServices.where((doc) {
...
//                     _allServices = snapshot.data!.docs;
...
//                                 onTap: () {
//                                   final category = filteredServices[index]['category'];
...
//                                 },
//                                 child: ServiceCard(
//                                   image: filteredServices[index]['image'] ?? '',
//                                   rating: (filteredServices[index]['rating'] ?? 0).toDouble(),
//                                   title: (filteredServices[index]['service_name'] ?? '').toString().toUpperCase(),
//                                 ),
//                               );
//                             },
//                           ),
