...
void selectRoom(String pet) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Image.asset("assets/image/pet2.png"),
          Padding(
                ...
                children: [
                  Padding(
                    ...
                    style: TextStyle(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 68,left: 18),
                        child: Material(
                          elevation: 5,
                          borderRadius: BorderRadius.circular(20),
                          child: Container(
                            child: Center(
                              child: Text("Bathing and drying",
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 105,left: 210),
                        child: Material(
                          elevation: 5,
                          borderRadius: BorderRadius.circular(20),
                          child: Container(
                            child: Center(
                              child: Text("Hair trimming and styling",
                            style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),)),
                            height: 30,
                            width: 190,
                            decoration: BoxDecoration(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 105,left: 18),
                        child: Material(
                          elevation: 5,
                          borderRadius: BorderRadius.circular(20),
                          child: Container(
                            child: Center(
                              child: Text("Nail clipping and paw care",
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 68,left: 180),
                        child: Material(
                          elevation: 5,
                          borderRadius: BorderRadius.circular(20),
                          child: Container(
                            child: Center(
                              child: Text("Ear cleaning and teeth brushing",
                            style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),)),
                            height: 30,
                            width: 220,
                            decoration: BoxDecoration(
       ...
       Padding(
        ...
        child: Column(
          ...
          // count
              Padding(
              padding: const EdgeInsets.only(top: 360,left: 300),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Column(
